    ...
    return (
        <article className="flex flex-col justify-start">
            ...
            <p className="text-gray-500 xs:text-sm md:text-xl">
                Mi nombre es Gastón Rojas y soy un desarrollador de software y padre de 27 años, con experiencia en diferentes herramientas y tecnologías. Además de contar con experiencia en diferentes áreas.
