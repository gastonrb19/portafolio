...
export default function Nav() {
    return (
        <nav className="pt-5 text-xs md:text-sm">
            <ul className="flex gap-4 justify-evenly">
                ...
                <li className="border-indigo-400 px-2 hover:border-indigo-100 hover:text-indigo-100 duration-200 cursor-pointer"><Link href="#contacto">Contacto</Link></li>
            </ul>
        </nav>
