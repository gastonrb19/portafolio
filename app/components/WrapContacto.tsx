...
export default function WrapContacto() {
    return (
        <section id="contacto" className="text-center bg-indigo-100 pb-10 px-2 pt-5 grid grid-cols-2 text-neutral-500 gap-x-10">
            ...
            <article className="grid grid-cols-1 gap-2 mx-auto text-center mb-9 mt-5 md:col-span-1 col-span-2 border-1 p-2 rounded-sm border-y-5 border-neutral-800 w-10/12">
                ...
                <Link className="w-fit mx-auto hover:text-indigo-700 duration-300 flex gap-2" target="_blank" href="https://wa.me/+56942151261">
                    <Image src="/wsp.png" alt="wsp-icon" width={20} height={20} className="w-6" />
                    +56942151261
                </Link>
                <Link className="w-fit mx-auto hover:text-indigo-700 duration-300 flex gap-2" href="mailto:gastonrb19@gmail.com">
                    <Image src="/gmail.png" alt="wsp-icon" width={20} height={20} className="w-6" />
                    gastonrb19@gmail.com
                </Link>
                <Link className="w-fit mx-auto hover:text-indigo-700 duration-300 flex gap-2" target="_blank" href="https://www.linkedin.com/in/gast%C3%B3n-rojas-barra-103b36386/">
