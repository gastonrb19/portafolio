...
export default function ItemWindows({
  ...
  return (
    <button
      className="
        text-black border-1 px-1 h-fit my-auto border-t-neutral-200 border-l-neutral-200 flex items-center gap-1 border-gray-700 shadow-inner active:shadow-gray-500 text-xs overflow-hidden flex-shrink-0 py-1"
      onClick={(e) => {
        setCurrentWindow(id);
        setWindows(
          windows.map((win) => {
