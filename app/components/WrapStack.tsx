...
export default function WrapStack() {
    return (
        <section id="stack" className="bg-indigo-100 text-neutral-900 px-4 mx-auto grid grid-cols-2 text-sm gap-2 py-5">
            ...
            <p className="col-span-2 text-center mb-5 text-xs text-gray-500 italic">Tecnologías que he utilizado</p>
            <div className="col-span-2 grid grid-cols-2 gap-2">
                <Stack name={"Backend"} color={"cyan"} iconName={"backend"} items={["Nodejs", "Nestjs", "Express", "Go", "Sequelize", "JWT", "REST", "Php"]} />
                <Stack name={"Frontend"} color={"cyan"} iconName={"frontend"} items={["React", "Nextjs", "Tailwindcss", "Css", "Html"]} />
